...
1.0 – Initial version.
1.1 – Small changes in source code. The license was changed to GNU GENERAL PUBLIC LICENSE.
1.2 – Small changes in source code.
1.3 – The program was totally rewritten.
1.3.1 – Small changes in source code.
1.4 – Russian localization is removed.
...
1.5 – Small changes.
1.5.0.1 – 1.5.0.6 – Documentation updated.